let Utils = {
  ...
  checkOptionalParams: function(input, params) {
    for (let index in params) {
      if (
        input.hasOwnProperty(params[index]) &&
  ...
  config: function() {
    ...
    let globalConfigs = require("../../config/global");
    let envConfigs = require("../../config/env/" + env);
    let finalConfigs = Object.assign(globalConfigs, envConfigs);
